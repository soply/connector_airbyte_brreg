...
class Representative(BRREGBatchBaseStream):
    ...
    def _header_accept(self) -> str:
        ...
        """
        return "application/vnd.brreg.enhetsregisteret.representant.v1+json"
    ...
    def parse_response(self, 
        ...
        yield from response.json()['_embedded']['representanter']
