...
class RoleGroupType(BRREGBatchBaseStream):
    ...
    def _header_accept(self) -> str:
        ...
        """
        return "application/vnd.brreg.enhetsregisteret.rollegruppetype.v1+json"
    ...
    def path(
        ...
        return "roller/rollegruppetyper"
    ...
    def parse_response(self, 
        ...
        yield from response.json()['_embedded']['rollegruppetyper']
